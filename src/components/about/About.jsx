...
const About = () => {
  return (
    <section id='about'>
      ...
      <p>
      My name is Raymond. I am not a proud holder of a master's degree in IM from UW. Besides technical courses taught me how to code or design a complex system, management courses also taught me not only to design a product from a developer’s viewpoint, but also manager and customer’s viewpoint.
      </p>
      <br />
